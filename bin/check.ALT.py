...
# alt_sv_vcf = "/data3/user/yangqimeng/github/svlearn/test_all/alt_sorted_format.vcf"
# alt_genome = "/data3/user/yangqimeng/github/svlearn/test_all/alt.fasta"
# alt_sv_bed = "/data3/user/yangqimeng/github/svlearn/test_all/alt.bed"

alt_sv_vcf = "/data3/user/yangqimeng/github/svlearn/test_filter/alt_sorted_format_filtered_sv.vcf"
alt_genome = "/data3/user/yangqimeng/github/svlearn/test_filter/alt.fasta"
alt_sv_bed = "/data3/user/yangqimeng/github/svlearn/test_filter/alt_sorted_format_filtered_sv.bed"
